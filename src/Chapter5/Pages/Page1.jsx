    ...
    <div className={`${className}`}>
      ...
      <div className='flex'>
        <ol className={`${olClass}`}>
          <li className={`${listClass}`}>1:準備</li>
          <li className={`${listClass}`}>2:VM作成</li>
          <li className={`${listClass}`}>3:OSのインストール</li>
          <li className={`${listClass}`}>3:ソフトウェアのインストール</li>
          <li className={`${listClass}`}>4:ソフトウェア設定</li>
        </ol>
      </div>
    </div>
  )
